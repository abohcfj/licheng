<template>
  <el-dialog title="导入物料" :visible.sync="open" width="400px" append-to-body>
    <el-upload ref="upload" :http-request="requestUpload" class="upload-demo" action="#" accept=".xlsx, .csv"
      ...
      <a style="font-size:12px;vertical-align: baseline;color: #1890ff;padding-left:10px" href="../../../../catecory.xlsx"
            download="最小采购单位信息.xlsx" >下载数据模板</a>
