<template>
  <div class="app-container">
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" icon="el-icon-plus" size="mini" @click="$refs.editForm.handleAdd()">添加物料</el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-input v-model="queryParams.keyword" placeholder="搜索：品线/品牌/物料类别/物料名称/物料编码/供应商代码" clearable size="mini"
