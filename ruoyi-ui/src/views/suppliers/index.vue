<template>
  <div class="app-container">
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" icon="el-icon-plus" size="mini" @click="$refs.editForm.handleAdd()">添加供应商</el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-input v-model="queryParams.keyword" placeholder="搜索：品线/供货商代码/供货商名称/跟进人" clearable size="mini"
    ...
    <el-table v-loading="loading" :data="supplierList" @selection-change="handleSelectionChange" ref="filterTable">
      ...
      <el-table-column label="供应商名称" align="center" prop="title">
        <template #header>
          <ParamSearch title="供应商名称" paramKey="title" :defaultArray="filterData('title')"
            @search="handleParamsSearch" />
        </template>
      </el-table-column>
      <el-table-column label="联系人" align="center" prop="contactName">
        <template #header>
          <ParamSearch title="联系人" paramKey="contactName" :defaultArray="filterData('contactName')"
            @search="handleParamsSearch" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="跟进人" align="center" prop="principal">
        <template #header>
          <ParamSearch title="跟进人" paramKey="principal" :defaultArray="filterData('principal')"
            @search="handleParamsSearch" />
        </template>
      </el-table-column>
